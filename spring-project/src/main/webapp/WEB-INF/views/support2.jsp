			...
			<div class="page-content">
				...
				<div class="col-lg-12">
					<ul class="nav">
						...
						<li class="nav-item"><a class="nav-link" href="#">자주하는 질문</a>
						</li>
					</ul>
				</div>
				<!-- NavBar end -->
				...
				<div class="live-stream" style="margin-top: 0px">
					<div class="heading-section row">
						...
						<div class="col-lg-4 main-button" style="text-align: right">
							<a href="support?page=notice"><i
								class="fa fa-ellipsis-h fa-lg" aria-hidden="true"></i></a>
						</div>
						...
						<div class="col-lg-12">
							<div class="item">
								<c:forEach begin="1" end="5" var="i">
									<p class="frequentlyQ"
										style="color: #fff; font-size: x-large; margin: 10px">Q${i}.
										질문${i} 입니다.</p>
									<p class="frequentlyA"
										style="background-color: #aaa; color: black; font-size: large; margin: 10px; display: none">A)
										답변${i} 입니다.</p>
								</c:forEach>
							</div>
						</div>
					...
					<div class="live-stream" style="margin-top: 35px">
						<div class="heading-section row">
							...
							<div class="col-lg-4 main-button" style="text-align: right">
								<a href="support?page=frequentlyQ"><i
									class="fa fa-ellipsis-h fa-lg" aria-hidden="true"></i></a>
							</div>
					...
					<div class="live-stream" style="margin-top: 35px">
						<div class="heading-section row">
							...
							<div class="col-lg-4 main-button" style="text-align: right">
								<a href="support?page=qa-board"><i
									class="fa fa-ellipsis-h fa-lg" aria-hidden="true"></i></a>
							</div>
						...
						<div class="row">
							<div class="col-lg-12">
								<c:forEach begin="1" end="5" var="i">
									<p class="question"
										style="color: #fff; font-size: x-large; margin: 10px">
										Q${i}. 유저질문${i} 입니다.
										<c:choose>
											<c:when test="${i eq 3}">
												<span style="font-size: x-large; margin-left: 20px">[답변
													완료]</span>
											</c:when>
											<c:otherwise>
									...
									<div class="answer"
										style="background-color: #aaa; color: black; font-size: large; margin: 10px; display: none">
										<c:choose>
											<c:when test="${i eq 3}">
												<b>작성자 : 김아무개${i}</b>
												<br>
